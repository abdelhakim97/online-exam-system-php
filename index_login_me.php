...
<body class="body_me" style="background-image: url(image/bg_me.jpg); background-size: 100%; background-repeat: no-repeat; background-attachment: fixed; background-position: center;">
    <div class="my_div">
        <header class="mt-4 m-3">
            ...
            <h6 class="d-inline text-white" id="b_abdou_user">BY ABDELHAKIM</h6>
        </header>
        <main class="my_main">

            <div class="text_content text-white" id="tex_cont_user">
            ...
            <div class="signup_login" style="border-top: 3px solid;border-left: 3px solid;border-right: 3px solid;border-bottom: 3px solid; border-radius: 17px; border-image:linear-gradient(to right, rgb(255 46 144) 0%, rgb(61 35 185) 100%) 5; ">
                <h1 style="width: 10cm;" ><span style="background-image: linear-gradient(to right, rgb(255 46 144), rgb(61 35 185)); -webkit-background-clip: text; -moz-background-clip: text;background-clip: text;    color: transparent;">Login to User</span>  </h1>
                <br>
                <form action="login.php?q=index.php" class="form-container" method="post">
                    <label for="psw"><b>Email</b></label>
                    <div class="inputField">
                        <input type="email" placeholder=" " / class="input_login" id="inp_email" onkeyup="keyup_login_Eamil()" name="email">
                    ...
                    <br>
                    <input type="submit" value="Login" class="btn_login" name="sb_Login">
                </form>
                <br>
                <span style="opacity: 0.7; font-size: 15px;">Don't have an account?</span> <a href="index.php" style="text-decoration: none; color: red; font-size: 15px" class="Signup">Sign up</a>
                <br><br>
